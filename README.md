...
### v1.5版本已发布！实现移动端支付方案 [立即获取源码和文档](http://xpay.exrick.cn/pay)
...
#### 注：v1.5源码（含原理及详细文档）获取方式 
- 进入 [XPay官网](http://xpay.exrick.cn/pay) 成功支付测试后 将自动发至你所填写的邮箱中

### 声明
> 此系统只针对个人开发收款支付，实际可应用到实现~~自动维护捐赠表等业务，无法商用~~！v1.5版本可已实现充值、发卡、自动发货等业务，可勉强供真正个人商用！日入百万千万的请绕道！当然你还可将此项目当作入门级的SpringBoot练习项目
...
- 如何确定收款来自哪笔交易订单？
    ...
    - v1.5版本已解决该问问题 [点我获取v1.5版本源码](http://xpay.exrick.cn/pay)
- 为什么不做自动监听？
